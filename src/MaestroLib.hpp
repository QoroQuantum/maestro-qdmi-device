...
public:
        ...
        if (Utils::Library::Init(libName)) {
            ...
            if (fGetMaestroObject) {
                ...
                if (maestro) {
                    ...
                    fDestroySimpleSimulator =
                        (void (*)(unsigned long int))GetFunction("DestroySimpleSimulator");
                    CheckFunction((void*)fDestroySimpleSimulator, __LINE__);

                    fRemoveAllOptimizationSimulatorsAndAdd =
                        (int (*)(unsigned long int simHandle, int simType, int simExecType))
                    ...
                    fConfigureSimulator =
                        (int (*)(void*, const char*, const char*))GetFunction("ConfigureSimulator");
                    ...
                    fAllocateQubits = (unsigned long int (*)(void*, unsigned long int))GetFunction(
                        "AllocateQubits");
                    ...
                    fMeasure = (unsigned long long int (*)(
                        void*, const unsigned long int*, unsigned long int))GetFunction("Measure");
                    ...
                    fProbability =
                        (double (*)(void*, unsigned long long int))GetFunction("Probability");
                    ...
                    fAmplitude =
                        (double* (*)(void*, unsigned long long int))GetFunction("Amplitude");
                    ...
                    fProbabilities = (double* (*)(void*, const unsigned long long int*,
                    ...
                    fRestoreInternalDestructiveSavedState =
                        (int (*)(void*))GetFunction("RestoreInternalDestructiveSavedState");
                    ...
                    fMeasureNoCollapse =
                        (unsigned long long int (*)(void*))GetFunction("MeasureNoCollapse");
                    ...
                    fApplyU =
                        (int (*)(void*, int, double, double, double, double))GetFunction("ApplyU");
                ...
                std::cout << "MaestroLibrary: Unable to get initialization function for library"
                          << std::endl;
        } else
            std::cout << "MaestroLibrary: Unable to load the library" << std::endl;
    ...
    int RemoveAllOptimizationSimulatorsAndAdd(unsigned long int simHandle, int simType,
                                              int simExecType)
    {
        if (maestro && fRemoveAllOptimizationSimulatorsAndAdd)
            ...
            throw std::runtime_error(
                "MaestroLibrary: Unable to remove all optimization simulators and add a new one.");
    ...
    unsigned long int GetNumberOfQubits(void* sim)
    {
        if (maestro && sim && fGetNumberOfQubits)
            ...
            throw std::runtime_error(
                "MaestroLibrary: Unable to get the number of qubits in the simulator.");
        return 0;
    }
    ...
    unsigned long long int* SampleCounts(void* sim, const unsigned long long int* qubits,
                                         unsigned long int nrQubits, unsigned long int shots)
    {
    ...
    int SaveStateToInternalDestructive(void* sim)
    {
        if (maestro && sim && fSaveStateToInternalDestructive)
            ...
            throw std::runtime_error(
                "MaestroLibrary: Unable to save the state to internal destructive storage.");
        return 0;
    }
    ...
    int RestoreInternalDestructiveSavedState(void* sim)
    {
        if (maestro && sim && fRestoreInternalDestructiveSavedState)
            ...
            throw std::runtime_error(
                "MaestroLibrary: Unable to restore the state from internal destructive storage.");
        return 0;
    }
    ...
    int ApplyCU(void* sim, int controlQubit, int targetQubit, double theta, double phi,
